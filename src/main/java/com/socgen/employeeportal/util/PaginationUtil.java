 ...
 * PaginationUtil
 * <p>
 * class to create response headers for pagination services
 *
...
public class PaginationUtil {
    ...
    public static <T> HttpHeaders generatePaginationHttpHeaders(ServletUriComponentsBuilder uriBuilder, Page<T> page) {
